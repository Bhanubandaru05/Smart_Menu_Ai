...
export default function CustomerMenu() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header */}
      <header className="sticky top-0 z-40 glass-strong border-b border-border flex-shrink-0">
      ...
      {restaurantInfo && (
        <footer className="border-t-2 border-primary/30 py-6 px-4 shadow-lg mt-auto flex-shrink-0" style={{ backgroundColor: '#5B7C99' }}>
