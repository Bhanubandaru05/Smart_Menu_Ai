...
const features = [
  ...
  },
  {
    ...
    description: 'Enterprise-grade security with data protection and reliable order management.',
    color: 'bg-destructive/10 text-destructive',
  },
  {
    icon: Smartphone,
    title: 'Mobile-First Design',
    description: 'Optimized for all devices with responsive design for seamless browsing experience.',
    color: 'bg-primary/10 text-primary',
  },
  {
    icon: ChartBar,
    title: 'Analytics & Insights',
    description: 'Track popular items, revenue trends, and order patterns to optimize your business.',
    color: 'bg-accent/10 text-accent',
  },
];
